...
require 'avromatic/model/attribute_type/array_type'
require 'avromatic/model/attribute_type/boolean_type'
require 'avromatic/model/attribute_type/custom_type_adapter'
require 'avromatic/model/attribute_type/date_type'
require 'avromatic/model/attribute_type/float_type'
require 'avromatic/model/attribute_type/integer_type'
require 'avromatic/model/attribute_type/map_type'
require 'avromatic/model/attribute_type/null_type'
require 'avromatic/model/attribute_type/record_type'
require 'avromatic/model/attribute_type/string_type'
require 'avromatic/model/attribute_type/timestamp_micros_type'
require 'avromatic/model/attribute_type/timestamp_millis_type'
require 'avromatic/model/attribute_type/type_factory'
require 'avromatic/model/attribute_type/union_type'
